package delivery.pipeline.common.api.domain.common.init;

import delivery.pipeline.common.api.domain.common.serviceInstance.CiInfo;
import delivery.pipeline.common.api.domain.common.serviceInstance.CiInfoService;
